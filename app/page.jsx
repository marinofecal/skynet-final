          ...
          <main className="relative w-full overflow-hidden bg-black">
              {/* Animated Background */}
                <div className="fixed inset-0 z-0">
                        ...
                        <div className="absolute top-1/3 right-0 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
                        <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl animate-pulse delay-500" />
                </div>div>
