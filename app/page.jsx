                ...
                <div className="max-w-7xl mx-auto w-full">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex gap-8 mb-12">
                            <div><div className="text-2xl font-bold text-cyan-400">3</div><div className="text-xs text-gray-500">AI MODULES</div></div>
                            <div><div className="text-2xl font-bold text-cyan-400">&lt;1s</div><div className="text-xs text-gray-500">RESPONSE</div></div>
                            <div><div className="text-2xl font-bold text-cyan-400">24/7</div><div className="text-xs text-gray-500">AVAILABLE</div></div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://linkedin.com/in/marinofecal" target="_blank" rel="noopener noreferrer" className="px-8 py-3 border border-gray-700 rounded-lg hover:border-cyan-500 transition">
                                LinkedIn Profile
                            </a>
                        </div>
                    </div>
            ...
            <section id="bots" className="py-24 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl sm:text-5xl font-bold mb-4">Intelligent Bots</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">Production-ready AI agents designed for real-world financial operations.</p>
                    </div>
                        ...
                        {bots.map((bot) => (
                            <Link key={bot.id} href={bot.link}>
                                <div className="glass-card rounded-2xl p-6 cursor-pointer group h-full">
                                    <div className="text-5xl mb-4 group-hover:scale-110 transition-transform">{bot.icon}</div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {bot.capabilities.map((cap, idx) => (
                                            <span key={idx} className="text-xs px-2 py-1 rounded-full bg-gray-800 text-gray-300">{cap}</span>
                                        ))}
                                    </div>
                                    <div className="flex items-center gap-2 text-cyan-400 text-sm font-mono group-hover:gap-3 transition-all">
                                        <span>LAUNCH BOT</span><span>→</span>
                                    </div>
                                </div>
                            </Link>
                        ))}
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Next.js', 'Tailwind CSS', 'OpenAI API', 'Vercel', 'TypeScript'].map((tech) => (
                            <span key={tech} className="px-4 py-2 rounded-full glass-dark text-sm">{tech}</span>
                        ))}
                    </div>
